...
|---------|-------------|------------|------|
| **🎬 YOLOv8 Object Tracking** | Real-time object detection and tracking system for videos and images | YOLOv8, Computer Vision, Python | [View →](https://github.com/Zakawat-Abbas/yolov8-object-tracking) |
| **🤟 Sign Language Recognition App** | Two-way sign language recognition system for deaf community communication (FYP) | React Native, CNN, Flask, TensorFlow | [View →](https://github.com/Zakawat-Abbas/SignLanguageProject) |
| **📊 Digital Meter Text Extraction** | Automated text extraction from digital meters using CNN | Computer Vision, CNN, Python | [View →](https://github.com/Zakawat-Abbas/Digital-Meter-Text-Extraction) |
| **📈 Stock Price Prediction** | LSTM model for accurate stock price predictions | LSTM, Deep Learning, Python | [View →](https://github.com/Zakawat-Abbas/Stock-Price-Prediction) |
| **😊 Emotion Detection System** | SVM-based AI system for emotion detection and analysis | SVM, Machine Learning, Python | [View →](https://github.com/Zakawat-Abbas/Emotion-Detection) |
...
| Project | Description | Tech Stack | Link |
|---------|-------------|------------|------|
| **🎤 Speech To Text Converter** | Real-time audio processing and transcription system | Google Speech API, Python | [View →](https://github.com/Zakawat-Abbas/Speech-To-Text) |
| **📱 GSM Arena Q&A System** | DialogFlow-powered Q&A system for mobile specifications | DialogFlow, NLP, Python | [View →](https://github.com/Zakawat-Abbas/GSMareana-QA) |
...
| Project | Description | Tech Stack | Link |
|---------|-------------|------------|------|
| **🏀 NBA Records EDA** | Exploratory data analysis for data-driven basketball strategies | Pandas, Matplotlib, Python | [View →](https://github.com/Zakawat-Abbas/NBA-Records-EDA) |
...
[![IEEE Xplore](https://img.shields.io/badge/IEEE_Xplore-Read_Paper-00629B?style=for-the-badge&logo=ieee)](https://ieeexplore.ieee.org/document/10593248)
[![ResearchGate](https://img.shields.io/badge/ResearchGate-View-00CCBB?style=for-the-badge&logo=researchgate)](https://researchgate.net/publication/382494916)
